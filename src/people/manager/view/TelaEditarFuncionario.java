...
public class TelaEditarFuncionario extends javax.swing.JFrame {
     ...
     * @param f
     */
    public TelaEditarFuncionario(String title, Funcionario f) {
        super(title);
        initComponents();
        jTextFieldID.setText(f.getId() + "");
        jTextFieldNome.setText(f.getNome());
        jTextFieldSobreNome.setText(f.getSobrenome());
        jTextFieldBairro.setText(f.getEndereco().getBairro());
        jTextFieldCEP.setText(f.getEndereco().getCep());
        jTextFieldCPF.setText(f.getCpf());
        jTextFieldCelular.setText(f.getCelular());
        jDateChooserNascimento.setCalendar(f.getNascimento());
        jTextFieldCidade.setText(f.getEndereco().getCidade());
        jTextFieldEmail.setText(f.getEmail());
        jTextFieldEstado.setText(f.getEndereco().getEstado());
        jTextFieldNumero.setText(f.getEndereco().getNumero());
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTextFieldEstado, javax.swing.GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextFieldCEP, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabelImgCep, javax.swing.GroupLayout.PREFERRED_SIZE, 15, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel10)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jLabelImagem, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            testeCampoVazio();
            try {
                ControllerFuncionario.editarFuncionario(Integer.parseInt(jTextFieldID.getText()), jTextFieldNome.getText().trim(), jTextFieldSobreNome.getText().trim(), jTextFieldCPF.getText().trim(), 0, jTextFieldCelular.getText().trim(), jTextFieldEmail.getText().trim(), Calendar.getInstance(), jDateChooserNascimento.getCalendar(), jTextFieldRua.getText().trim(), jTextFieldNumero.getText().trim(), jTextFieldCEP.getText().trim(), jTextFieldBairro.getText().trim(), jTextFieldCidade.getText().trim(), jTextFieldEstado.getText().trim());
                JOptionPane.showMessageDialog(null, "Funcionario editado com sucesso");
                Controller.novoLog("editou um funcionario onde o CPF é " + jTextFieldCPF.getText().trim());
                dispose();
