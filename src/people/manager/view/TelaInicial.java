...
public class TelaInicial extends javax.swing.JFrame {
    ...
    public TelaInicial(String title, Usuario user) {
        ...
        temAniversariante();
        setIcons();
        jTextPaneAlertas.setText("Alerta de Aniversário");
        temAgendamentoHoje();
    ...
    private void initComponents() {
        ...
        jTextPaneAlertas = new javax.swing.JTextPane();
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/people/manager/view/icone_agenda.png"))); // NOI18N
        ...
        jTextPaneAlertas.setEditable(false);
        jScrollPane1.setViewportView(jTextPaneAlertas);

        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/people/manager/view/user_add.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/people/manager/view/pes.png"))); // NOI18N
    ...
    private void jMenuItem13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem13ActionPerformed
        TelaBuscaFuncionarios tbv = new TelaBuscaFuncionarios("Busca Funcionarios");
    ...
    private javax.swing.JTextPane jTextPaneAlertas;
    ...
    private void temAgendamentoHoje() {
        ArrayList a;
        try {
            a = ControllerAtendimento.buscar(Calendar.getInstance());
            if(!a.isEmpty())
                jTextPaneAlertas.setText("Alerta de Agenda");
